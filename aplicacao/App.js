...
const products = 
  [ { id: "1", 
    ...
    images: { 
        Preto: require("./assets/puma.png"), 
        Amarelo: require("./assets/puma_amarelo.png"), 
        Verde: require("./assets/puma_verde.png"), } }, 
  ...
  { id: "3", 
    ...
    images: { 
      Branco: require("./assets/nike_branco.png"), 
      Verde: require("./assets/nike_verde.png"), 
      Preto: require("./assets/nike_preto.png"), } }, 
  ...
  { id: "4", 
    ...
    images: { 
      Branco: require("./assets/airforce_branco.png"), 
      Rosa: require("./assets/airforce_rosa.png"), 
      Preto: require("./assets/airforce_preto.png"), } }, 
  ...
  { id: "5", 
    ...
    images: { 
      Preto: require("./assets/superstar_preto.png"), 
      Vermelho: require("./assets/superstar_vermelho.png"), 
      Marrom: require("./assets/superstar_marrom.png"), } },

  { id: "6", 
    name: "Adidas Gazelle", 
    price: 599, 
    colors: ["Preto", "Verde", "Vermelho"], 
    images: { 
      Preto: require("./assets/gazelle_preto.png"), 
      Verde: require("./assets/gazelle_verde.png"), 
      Vermelho: require("./assets/gazelle_vermelho.png"), } },
  ...
  { id: "7", 
    ...
    images: { 
      Preto: require("./assets/palermo_preto.png"), 
      Branco: require("./assets/palermo_branco.png"), 
      Verde: require("./assets/palermo_verde.png"), } }, 

  { id: "8", 
    name: "Nike Air-Max 1", 
    price: 599, 
    colors: ["Preto", "Creme", "Bege"], 
    images: { 
      Preto: require("./assets/airmax1_preto.png"), 
      Creme: require("./assets/airmax1_creme.png"), 
      Bege: require("./assets/airmax1_bege.png"), } },

  { id: "9", 
    name: "Nike Air-Max 1", 
    price: 599, colors: ["Mike", "Sully", "Pelinho"], 
    images: { 
      Mike: require("./assets/crocs_mike.png"),
      Sully: require("./assets/crocs_sully.png"), 
      Pelinho: require("./assets/crocs_pelinho.png"), } },

  { id: "10", 
    name: "Nike Air-Max 1", 
    price: 599, 
    colors: ["Batata", "J", "Pikachu", "Yodinha"], 
    images: { 
      Batata: require("./assets/jibbitz_batata.png"), 
      J: require("./assets/jibbitz_J.png"), 
      Pikachu: require("./assets/jibbitz_pika.png"), 
      Yodinha: require("./assets/jibbitz_yodinha.png") } },  
];
...
return (
  ...
  <View style={styles.container}>
    ...
    <View style={styles.container3}>
      ...
      <TouchableOpacity onPress={() => setModalVisible(true)}>
        ...
        <TouchableOpacity onPress={() => setLoginModalVisible(true)}>
          <Ionicons style={styles.iconelogin} name="person" size={25} color="black" />
        </TouchableOpacity>
      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          <View style={styles.settingItem}>
            <Text style={{ fontSize: 17, fontWeight: "bold",  fontFamily: "Jost_700Bold" }}>Tema Escuro</Text>
            <Switch
            
            
            
            value={isDarkTheme} onValueChange={setIsDarkTheme} />

            
          </View>

          <View style={styles.settingItem}>
            <Text style={{ fontSize: 17, fontWeight: "bold",  fontFamily: "Jost_700Bold" }}>Exibir Tênis</Text>
            <Switch value={isShoes} onValueChange={setIsShoes} />
          </View>

          <Text style={{ fontSize: 17, fontWeight: "bold",  fontFamily: "Jost_700Bold", }}>
            Filtrar por Marca
            </Text>

          <Picker

          style={{ width: 100, height: 50, color: "white", backgroundColor: "#333", borderRadius:10, textAlign:"center",justifyContent:"center" }}
           mode="dropdown"




          selectedValue={selectedBrand} onValueChange={setSelectedBrand}>
          ...
          style={{ width: 80, height: 50, color: "white", backgroundColor: "#333", borderRadius:10, textAlign:"center" }}
           mode="dropdown"
          
          
          selectedValue={selectedSize} onValueChange={setSelectedSize}>
            {[35, 36, 37, 38, 39, 40, 41, 42].map(size => (
          ...
          />
            ...
            <Text>Itens por fileira: {itemsPerrow}</Text>
          <Slider
           style={{ width: 250, height: 40 }}
           minimumValue={1}
           maximumValue={10}
          ...
          />
            ...
            style={({ pressed }) => [
              ...
              >
            <Text style={{ color: "white", fontSize: 16,  fontFamily: "Jost_700Bold" }}>Fechar</Text>
          </Pressable>
        </View>
        </View>
      </Modal  >
                            ...
                            {/* Modal de Login */}
      <Modal visible={loginModalVisible} animationType="fade" transparent={true}>
    <View style={styles.overlay}>
    <View style={styles.modalContainer2}>
      ...
      Please enter your email address to start.</Text>
      ...
      >
        <Text style={{ color: "white", fontSize: 18, fontFamily: "Jost_700Bold", textAlign:"center" }}>
          Continue
        </Text>
      </Pressable>
      </View>
...
iconelogin:{
  ...
  position: "absolute",
  top: -200,  // Ajuste a altura conforme necessário
  left:30 // Ajuste a distância da borda direita
...
searchInput: { marginTop:30, height: 80, backgroundColor: "black", borderRadius: 40, fontFamily: "Jost_400Regular", fontSize: 16, width:"90%", alignSelf: "center", textAlign:"center", color:"white",
...
image: 
{ width:"130%", height: 200, resizeMode: "contain", marginBottom: 10 },
...
teamHeader: { fontSize: 30, fontFamily: "Jost_700Bold", textAlign: "center", marginTop: 20, 
},
